...
class ApplicationGlobalAlertMCPTools(BaseInstanaClient):
    ...
    async def find_active_global_application_alert_configs(self,
        ...
        try:
            ...
            if hasattr(api_client, "find_active_global_application_alert_configs_without_preload_content"):
            ...
            elif hasattr(api_client, "find_active_global_application_alert_configs"):
                logger.warning("SDK method find_active_global_application_alert_configs_without_preload_content not available, using standard SDK method")
                ...
                logger.warning("SDK does not expose active global application alert config lookup methods; returning empty result")
                result = []
    ...
    async def find_global_application_alert_config(self,
        ...
        try:
            ...
            if not id:
                logger.warning("No global application alert configuration id provided; returning empty result")
